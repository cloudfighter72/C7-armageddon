...
DB_ID="${DB_ID:-armageddon-db}"                   # RDS DBInstanceIdentifier
...
usage() {
  cat <<EOF
Usage:
  REGION=us-east-2 INSTANCE_ID=i-0dd6447b2f3ab96b8 DB_ID=armageddon-db ./scripts/gate_network_db.sh
...
Examples:
  ...
  CHECK_PRIVATE_SUBNETS=true REGION=us-east-2 INSTANCE_ID=i-0dd6447b2f3ab96b8 DB_ID=armageddon-db ./scripts/gate_network_db.sh
EOF
}
